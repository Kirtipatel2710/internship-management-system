...
const dummyData = {
  ...
  weeklyReportsApproved: 7,
  weeklyReportsPending: 3,
  certificatesUploaded: 5,
  certificatesApproved: 3,
  certificatesPending: 1,
  certificatesRejected: 1,
}
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{dummyData.weeklyReportsSubmitted}</div>
          <p className="text-xs text-muted-foreground">
            {dummyData.weeklyReportsApproved} Approved, {dummyData.weeklyReportsPending} Pending
          </p>
          <Progress
            value={(dummyData.weeklyReportsApproved / dummyData.weeklyReportsSubmitted) * 100 || 0}
            className="mt-2"
          />
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{dummyData.certificatesUploaded}</div>
          <p className="text-xs text-muted-foreground">
            {dummyData.certificatesApproved} Approved, {dummyData.certificatesPending} Pending
          </p>
          <Progress
            value={(dummyData.certificatesApproved / dummyData.certificatesUploaded) * 100 || 0}
            className="mt-2"
          />
        </CardContent>
      </Card>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Your NOC for Tech Solutions Inc. has been approved by TPO.
                </p>
              </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Your application for Data Analyst at XYZ Corp was rejected.
                </p>
              </div>
